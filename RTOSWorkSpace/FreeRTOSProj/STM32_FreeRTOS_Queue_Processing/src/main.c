...
int main(void)
{
	...
	{
		//lets create task-1
		Status1 = xTaskCreate(vTask1_menu_display,"TASK1-MENU",500,NULL,1,&xTaskHandle1);
		if(Status== config_PDPass)
		//lets create task-2
		Status1 = xTaskCreate(vTask2_cmd_handling,"TASK2-CMD-HANDLING",500,NULL,2,&xTaskHandle2);
